...
if __name__ == '__main__':
    ...
    model_name_list = ['vit_tiny_patch16_224.augreg_in21k_ft_in1k', 'inception_v3', 'efficientnet_b0.ra4_e3600_r224_in1k', 'resnet18', 'resnet34','wide_resnet50_2.racm_in1k', 'vgg16.tv_in1k', 'resnet18.a1_in1k']
    model_input_size = [224, 229, 224, 224, 224, 224, 224, 224]
    ...
    model_name_list = ['mobilenet_v2', 'resnet101.a1h_in1k', 'resnet50.a1_in1k']
    model_input_size = [224, 224, 224]
    print(model_name_list)
    model_list = []
    for model_name in model_name_list:
        temp_model = get_architecture(model_name, device).cuda()
